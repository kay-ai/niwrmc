                            ...
                            <tr>
                                ...
                                <td class="action-btn">
                                    <div class="btn-group btn-group-sm" role="group">
                                        <a class="btn btn-kdis btn-sm" href="javascript:void(0);" onclick="viewAssignRole({{$user->id}}, '{{$user->email}}', '{{count($user->getRoleNames())>0 ? $user->getRoleNames()[0] : ''}}')" role="button">
