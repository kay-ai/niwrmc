                    ...
                    <form action="/generate-invoice" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6 text-center">
                                <h4>You are to pay a non-refundable processing fee of <strong>&#8358;{{number_format($application->license_sub_category->processing_fee, 2) ?? 'No Fee Added For this License'}}</strong></h4>
